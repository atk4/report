...
class UnionExprTest extends \atk4\schema\PHPUnit_SchemaTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->t = new Model\Transaction2($this->db);
    }
    ...
    public function testBasics()
    {
        ...
        $t = new Model\Transaction2($this->db);
        $this->assertEquals([
    ...
    public function testReference()
    {
        ...
        $this->assertEquals(
            'select sum("val") from ('.
                '(select sum(-"amount") "val" from "invoice" where "client_id" = :a) '.
                'UNION ALL '.
                '(select sum("amount") "val" from "payment" where "client_id" = :b)'.
            ') "derivedTable"',
